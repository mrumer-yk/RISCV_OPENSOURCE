module seven_segment_display(
    input [3:0] digit,           // 4-bit input for the 7-segment display
    output reg [6:0] segments    // 7-segment output (for common cathode)
);

    // Convert 4-bit input to 7-segment representation (common cathode)
    always @(*) begin
        case (digit)
